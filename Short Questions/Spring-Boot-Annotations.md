...
|------------------|-----------------------------------------------------------|-------------------------------------------------|---------------------------------------------------|
| **When to Use**  | **Mandatory** dependencies required at object creation.   | **Optional** dependencies or configurable ones. | Generally **avoid**; hides dependencies.          |
| **Immutability** | High – dependencies **cannot change** after construction. | Low – dependencies **can change** anytime.      | Low – dependencies can change anytime.            |
| **Testability**  | High – dependencies explicit and easy to mock.            | Moderate – risk of missing setter calls.        | Low – **harder** to test/mock, reflection needed. |
