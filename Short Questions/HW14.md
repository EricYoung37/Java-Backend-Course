...
1. [Basic Concepts](#question-1)
2. [Partition & Consumer Idleness](#question-2)
3. [Broker Coordination](#broker-coordination)
4. [Replication Parameters](#data-replication)
5. [Message Consumption](#question-4)
6. [`enable.idempotence=true`](#idempotence)
7. [`acks` & Data Loss](#acknowledgement-level)
8. [Will data be lost if some consumers in a consumer group are down?](#question-6)
9. [Will data be lost if an entire consumer group is down?](#question-7)
10. [Consumer Lag & Solutions](#question-8)
11. [Delivery Guarantess & Data Loss & Data Duplication](#question-9)
12. [Kafka vs. RabbitMQ](#question-10)
